...
![ScreenShot](legacy/assets/create-app.png)

### 3. Once deployed press `Manage App` button.
![ScreenShot](legacy/assets/app-deployed.png)

### 4. Go to settings tab.
![ScreenShot](legacy/assets/go-to-settings-tab.png)

### 5. Press `Reveal Config Vars` button and set environment variables.
![ScreenShot](legacy/assets/set-env-variables.png)
